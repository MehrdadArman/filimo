...
export const axiosApiInstance = axios.create({ withCredentials: true });

// Request interceptor for API calls
axiosApiInstance.interceptors.request.use(
    (config) => {
        config.headers = {
            // 'Access-Control-Allow-Origin': '*',  ====> i set this header  but CORS Error again handle it with CORS extension
